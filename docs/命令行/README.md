...
框架根目录的 `cmd/thinkgo` 是可安装 CLI，命令系统位于 `console/`。使用 `go install github.com/zhuhanxin0308/thinkgo/v3/cmd/thinkgo@v3.0.0` 安装，再用 `thinkgo create <项目名称>` 创建完整项目。目标目录必须不存在或为空。
