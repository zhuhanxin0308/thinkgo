...
func TestReservedControllerMethods(t *testing.T) {
	reserved := []string{"View", "Fetch", "Success", "Error", "Result", "Redirect", "Validate", "Initialize", "SetMiddleware", "GetMiddleware", "Assign"}
	...
	allowed := []string{"Index", "Detail", "Profile", "List", "Init"}
