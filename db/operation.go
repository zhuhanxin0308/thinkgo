...
func newSelectRequest(table, fields string, predicate Predicate, primaryKey, order string, limit, offset int, aggregate *AggregateExpression, modelKey ...string) SelectRequest {
	...
	return SelectRequest{table: table, fields: fields, predicate: predicate.clone(), primaryKey: primaryKey, modelKey: resolveRequestModelKey(primaryKey, modelKey), order: order, limit: limit, offset: offset, aggregate: aggregateCopy}
}
...
func newUpdateRequest(table string, data map[string]interface{}, predicate Predicate, primaryKey string, modelKey ...string) UpdateRequest {
	return UpdateRequest{table: table, data: cloneDatabaseMap(data), predicate: predicate.clone(), primaryKey: primaryKey, modelKey: resolveRequestModelKey(primaryKey, modelKey)}
}
...
func newDeleteRequest(table string, predicate Predicate, primaryKey string, detachRelations bool, modelKey ...string) DeleteRequest {
	return DeleteRequest{table: table, predicate: predicate.clone(), primaryKey: primaryKey, modelKey: resolveRequestModelKey(primaryKey, modelKey), detachRelations: detachRelations}
}
...
func newCountRequest(table string, predicate Predicate, primaryKey string, modelKey ...string) CountRequest {
	return CountRequest{table: table, predicate: predicate.clone(), primaryKey: primaryKey, modelKey: resolveRequestModelKey(primaryKey, modelKey)}
}
