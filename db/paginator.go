...
func (p *Paginator[T]) Offset() (int, error) {
...
// ToMap 转换为业务层常用的响应结构。
func (p *Paginator[T]) ToMap() map[string]interface{} {
	if p == nil {
...
func buildPaginator[T any](list []T, total int64, page int, pageSize int) (*Paginator[T], error) {
	if page < 1 {
		page = 1
	}
	if pageSize < 1 {
