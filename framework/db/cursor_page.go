...
func (p *CursorPage) ToMap() map[string]interface{} {
	if p == nil {
...
func (q *Query) SeekPage(pageSize int, pkField string, after interface{}) (*CursorPage, error) {
	return q.SeekPageWithCodec(pageSize, pkField, OrderedCursorCodec{}, after)
}

// SeekPageWithCodec 使用显式排序 codec 执行游标分页，支持文本、二进制和自定义主键。
func (q *Query) SeekPageWithCodec(pageSize int, pkField string, codec CursorCodec, after interface{}) (*CursorPage, error) {
